...
def generate_mesh(points, colours, normals, output_path, depth=12, laplacian_iters=10, std_ratio=3):
    ...
    print(f"   共去除 {original_count - len(point_cloud.points)} 个离群点")
    ...
    print(f"   网格三角面数：{len(mesh.triangles)}")
